...
export const Helper = {
    addBrokerHelper: (
        ...
        setTimeout(() => {
            CommonHelper.replaceContent(
                Helper.createParamsForAddBrokerHelper(
                    'create',
    ...
    createService: (
        ...
        if (
            !CommonHelper.isAlreadyExist(Config.moleculer.interfaceDir, answers.upperFileName, true)
        ) {
            Helper.createInterface(
                answers,
                'Services',
    ...
    createServiceHelper: (
        ...
        const writeFileProps: ICommon.IWriteFile = {
            ...
            getFileContent: () =>
                CommonHelper.getTemplate(createServiceHelperParams.templatePath, templateProps),
        ...
        const addIndexParams: ICommon.IAddIndex = {
            ...
            getFileContent: () =>
                CommonHelper.getTemplate(createServiceHelperParams.indexTemplate, templateProps),
