...
fs.writeFileSync(
    ...
    'Test template nextjs.mustache {{fileName}}'
);
...
fs.writeFileSync(
    ...
    realFs.readFileSync(
        path.resolve(__dirname, '../src/Templates/nextjs/Interfaces/ComponentIndex.mustache')
    )
);
fs.writeFileSync(
    '/Templates/nextjs/Interfaces/Component.mustache',
    realFs.readFileSync(
        path.resolve(__dirname, '../src/Templates/nextjs/Interfaces/Component.mustache')
    )
);
fs.writeFileSync(
    '/Templates/nextjs/Interfaces/ComponentIndex.mustache',
...
fs.writeFileSync(
    ...
    realFs.readFileSync(
        path.resolve(__dirname, '../src/Templates/nextjs/Interfaces/PageIndex.mustache')
    )
);
fs.writeFileSync(
    '/Templates/nextjs/Interfaces/ReduxImport.mustache',
    realFs.readFileSync(
        path.resolve(__dirname, '../src/Templates/nextjs/Interfaces/ReduxImport.mustache')
    )
);
fs.writeFileSync(
    '/Templates/nextjs/Interfaces/ReduxStore.mustache',
    realFs.readFileSync(
        path.resolve(__dirname, '../src/Templates/nextjs/Interfaces/ReduxStore.mustache')
    )
);
...
fs.writeFileSync(
    ...
    realFs.readFileSync(
        path.resolve(__dirname, '../src/Templates/nextjs/Components/Class.mustache')
    )
);
fs.writeFileSync(
    '/Templates/nextjs/Components/index.mustache',
    realFs.readFileSync(
        path.resolve(__dirname, '../src/Templates/nextjs/Components/index.mustache')
    )
);
...
fs.writeFileSync(
    ...
    realFs.readFileSync(
        path.resolve(__dirname, '../src/Templates/nextjs/Reducers/Reducer.mustache')
    )
);
...
fs.writeFileSync(
    ...
    realFs.readFileSync(
        path.resolve(__dirname, '../src/Templates/nextjs/Reducers/ActionConst.mustache')
    )
);
...
fs.writeFileSync(
    ...
    realFs.readFileSync(
        path.resolve(__dirname, '../src/Templates/nextjs/Reducers/ActionIndex.mustache')
    )
);
...
fs.writeFileSync('/src/Actions/index.ts', `export { HomeActions } from './HomeActions';`);

fs.writeFileSync('/src/Interfaces/index.ts', '// PAGE INTERFACES\n\n// COMPONENT INTERFACES');
fs.writeFileSync(
    '/src/Interfaces/Redux/Store.d.ts',
...
fs.writeFileSync(
    '/src/Definitions/ActionConsts.ts',
...
fs.writeFileSync(
    ...
    realFs.readFileSync(
        path.resolve(__dirname, '../src/Templates/nextjs/Components/Functional.mustache')
    )
);
fs.writeFileSync(
    '/Templates/nextjs/Components/index.mustache',
