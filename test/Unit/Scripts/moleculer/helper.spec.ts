...
describe('Helpers tests', () => {
    ...
    it('should createEntityInstance', () => {
        ...
        expect(fileContent).toBe(
            CommonHelper.getTemplate(createEntityTemplatesParams.templatePath, answers)
        );
    ...
    it('should createInterface', () => {
        ...
        expect(fileContent).toBe(
            CommonHelper.getTemplate(
                createInterfaceParams.templatePath + `/${prefix}Interface.mustache`,
                templateProps
            )
        );
    ...
    it('should createRepository', () => {
        ...
        expect(fileContent).toBe(
            CommonHelper.getTemplate(createRepositoryParams.templatePath, templateProps)
        );
        ...
        expect(indexFileContent).toBe(
            CommonHelper.getTemplate(createRepositoryParams.indexTemplate, answers)
        );
        ...
        expect(fileEntityContent).toBe(
            CommonHelper.getTemplate(
                createRepositoryParams.createEntityTemplatesParams.templatePath,
                answers
            )
        );
        ...
        expect(fileIndexContent).toBe(
            CommonHelper.getTemplate(
                createRepositoryParams.createEntityTemplatesParams.indexTemplate,
                answers
            )
        );
    });
    ...
    it('should createService', () => {
        ...
        expect(fileContent).toBe(
            CommonHelper.getTemplate(createServiceParams.templatePath, answers)
        );
        ...
        expect(indexFileContent).toBe(
            CommonHelper.getTemplate(createServiceParams.indexTemplate, answers)
        );
        ...
        expect(serviceHelperFileContent).toBe(
            CommonHelper.getTemplate(
                createServiceParams.createServiceHelperParams.templatePath,
                answers
            )
        );
        ...
        expect(testFileContent).toBe(
            CommonHelper.getTemplate(
                createServiceParams.createServiceHelperParams.testTemplatePath,
                answers
            )
        );
        ...
        const addBrokerHelperFileContent = CommonHelper.getTemplate(
            createServiceParams.brokerHelperTemplatesParams.brokerHelperImport,
            answers
        );
    ...
    it('should createServiceHelper', () => {
        ...
        expect(fileContent).toBe(
            CommonHelper.getTemplate(createServiceHelperParams.templatePath, answers)
        );
    });
});
