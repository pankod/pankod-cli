...
describe('Common Helper', () => {
    ...
    describe('getTemplate', () => {
        it('should get template', () => {
            const template = CommonHelper.getTemplate('/src/Templates/nextjs/nextjs.mustache', {
                fileName: 'test'
            });
    ...
    describe('isAlreadyExist', () => {
        ...
        describe('folder', () => {
            describe('when folder exist', () => {
                it('should return true', () => {
                    const isAlreadyExist = CommonHelper.isAlreadyExist('/app', 'test');
            ...
            describe('when folder doesnt exist', () => {
                it('should return false', () => {
                    const isAlreadyExist = CommonHelper.isAlreadyExist('/app3');
