...
const prepareOptions = (answers, custom) => {
    ...
    return Object.assign(Object.assign(Object.assign({}, answers), { fileName: capitalizedName, 
        // TODO: Rename 'upperFileName' as 'capitalizedFileName'
        upperFileName: capitalizedName, lowerFileName: unCapitalizedName, interfaceName: `I${capitalizedName}` }), custom);
};
