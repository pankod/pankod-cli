...
exports.Helper = {
    addRoute: (answers) => {
        ...
        const replaceContentParams = {
            ...
            getFileContent: () => Common_1.CommonHelper.getTemplate('./src/Templates/nextjs/Routes.mustache', templateProps),
    ...
    addActionConstIndex: (templateProps) => {
        const replaceContentParams = {
            ...
            getFileContent: () => Common_1.CommonHelper.getTemplate('./src/Templates/nextjs/Reducers/ActionConst.mustache', templateProps),
    ...
    addReducer: (answers) => {
        ...
        const replaceContentParams = {
            ...
            getFileContent: () => Common_1.CommonHelper.getTemplate('./src/Templates/nextjs/Reducers/index.mustache', templateProps),
        ...
        setTimeout(() => {
            const replaceReducerContentParams = {
                fileDir: `${config_1.Config.nextjs.reducerDir}/index.ts`,
                filetoUpdate: fs.readFileSync(path.resolve('', `${config_1.Config.nextjs.reducerDir}/index.ts`), 'utf8'),
                getFileContent: () => Common_1.CommonHelper.getTemplate('./src/Templates/nextjs/Reducers/Store.mustache', templateProps),
